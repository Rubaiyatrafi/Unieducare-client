...
const Footer = () => {
  return (
    <footer className="footer footer-center p-10 bg-gradient-to-r from-orange-100 via-purple-100 to-pink-100 ">
      <div>
        <div>
        ...
        <p className="font-bold">
          ...
          <br />
          <span className=" text-slate-500 font-extrabold text-base">
